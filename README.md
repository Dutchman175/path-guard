...
**UX (build 51+):** Compact phone controls (scrollable tower strip + denser util/wave chrome); Choose Map scroll no longer picks a map (tap only); Barrage removed; **Barrier** path-halt; hide controls until map picked; FAQ; cost-sorted bar; Bank income; 10 lives; 5x speed; **Crucible** nightmare map; gold bonuses / Challenge branding removed; **40 waves**.
