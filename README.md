...
**Towers (build 53 roster):** Archer · Barrier · Crossbow · Frost · Bank · Fire · Cannon · Lightning · Sniper (cost order). Categories: **M**arksman · **E**lemental · **G**unnery · **S**upport. Counters matter — Marksman weak/Immune vs Shell/Titan; Frost/Lightning Scout Immune; Gunnery/Lightning answer armor. **Beacon removed.**
...
**UX (build 53):** Big center/top counter toasts when a tower cannot hurt / is weak vs a foe (plus larger floats + grey shield X). Wider L1 cost ladder; Sniper nerfed (pricier, slower, less damage). FAQ notes the toast. 40 waves / Titans on 20 & 40 unchanged.
