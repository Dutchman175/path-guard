...
**UX (build 54):** Removed cryptic M/E/G/S chips under tower icons; selected-tower hint and FAQ use full category names (Marksman, Elemental, Gunnery, Support). Counter logic unchanged. (Build 53: counter toasts, wider L1 costs, Sniper nerf.)
