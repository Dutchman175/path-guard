...
**UX (build 61):** Wider equal-share category drill-down buttons (Back ~60–70px fixed, tower buttons `flex:1` min ~90–96px, icons ~48px); Crossbow + Scout true-alpha art; sprite cache `?v=61`. (Build 60: Support last, bigger cat icons, clean Scout. Build 59: category menu + Crossbow art.)
