...
**UX (build 57):** Tower **Can't hit** list and enemy intro cards lead with **large color swatches** + big readable names (no tiny sprite chips). Intro **Immune to** is large category-colored tower pills; one short blurb. Tower combat stats unchanged from build 56. Towers skip Immune targets. (Build 56: full tower stats + can't-hit only. Build 55: tower detail + intros. Build 54: full category names.)
