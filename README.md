...
**Towers (build 56 roster):** Archer · Barrier · Crossbow · Frost · Bank · Fire · Cannon · Lightning · Sniper (cost order). Categories: Marksman · Elemental · Gunnery · Support (shown as full words in the hint/FAQ; no letter chips on buttons). Counters matter — Marksman weak/Immune vs Shell/Titan; Frost/Lightning Scout Immune; Gunnery/Lightning answer armor. **Beacon removed.**
...
**UX (build 56):** Tower detail popup shows full combat stats (damage, fire interval + shots/sec, range, splash/multi/slow/burn, support income/halt, cost/level/upgrade) and only **Can't hit** enemies (sprites); no Can-hit row. One-time enemy intro cards (`pg-enemy-intro-v1`). Towers skip Immune targets. (Build 55: tower detail + intros. Build 54: full category names. Build 53: counter toasts, Sniper nerf.)
