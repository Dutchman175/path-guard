...
**Towers (cheap → pricey):** Barrage (swarm shredder), Beacon (slow aura), Archer, Frost, **Bank** (+gold each wave clear, no shots), Cannon (splash), Sniper (map-wide), Zap (multi). Streak bounties every 5 kills.
...
**UX (build 43+):** hide tower bar + bottom controls until a map is picked; FAQ from Choose Map / util; towers ordered by cost; Bank income tower; clearer controls from build 42.
